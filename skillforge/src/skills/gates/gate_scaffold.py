    ...
    def execute(self, input_data: dict[str, Any]) -> dict[str, Any]:
        ...
        if validation_errors:
            ...
            capture_gate_event(
                ...
                summary="scaffold gate rejected due to input validation failure",
            )
            return result
        ...
        # Retrieve historical templates by IssueKey/FixKind for downstream scaffold use.
        experience_templates = retrieve_experience_templates(
            issue_key="SCAFFOLD-*",
        ...
        capture_gate_event(
            ...
            evidence_refs=result["evidence_refs"],
            fix_kind=FixKind.UPDATE_SCAFFOLD,
            summary="scaffold output validated and chained into delivery gates",
            metadata={"template_count": len(experience_templates)},
        )
        return result
