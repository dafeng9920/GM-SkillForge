...
input:
  description: "将 receipt hash 统一为 SHA-256 canonical payload"
  context_files:
...
compliance:
  required: true
  attestation_path: "docs/2026-02-26/p0-governed-execution/verification/T08_compliance_attestation.json"
