...
input:
  description: "实现 Evidence Envelope + Body 结构与 schema 对齐"
  context_files:
...
compliance:
  required: true
  attestation_path: "docs/2026-02-26/p0-governed-execution/verification/T03_compliance_attestation.json"
