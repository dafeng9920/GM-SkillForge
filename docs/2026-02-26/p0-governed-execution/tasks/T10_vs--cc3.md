...
input:
  description: "将协议测试接入 CI 作为 required gate"
  context_files:
...
compliance:
  required: true
  attestation_path: "docs/2026-02-26/p0-governed-execution/verification/T10_compliance_attestation.json"
