...
input:
  description: "建立宪法防绕过基线（policy_check + fail-closed + 审计字段）"
  context_files:
...
compliance:
  required: true
  attestation_path: "docs/2026-02-26/p0-governed-execution/verification/T01_compliance_attestation.json"
