...
input:
  description: "实现 nonce challenge/ttl 与 replay 拒绝"
  context_files:
...
output:
  deliverables:
    - path: "docs/2026-02-26/p0-governed-execution/verification/T06_nonce_report.md"
      type: "新建|修改"
      schema_ref: "n/a"
  constraints:
    - "不得越权修改其他任务输出文件"
...
compliance:
  required: true
  attestation_path: "docs/2026-02-26/p0-governed-execution/verification/T06_compliance_attestation.json"
