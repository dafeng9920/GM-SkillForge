...
input:
  description: "建立 node registry 与 NODE_UNTRUSTED 拒绝"
  context_files:
...
compliance:
  required: true
  attestation_path: "docs/2026-02-26/p0-governed-execution/verification/T07_compliance_attestation.json"
