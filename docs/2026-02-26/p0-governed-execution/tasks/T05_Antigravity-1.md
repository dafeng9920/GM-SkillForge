...
output:
  deliverables:
    - path: "docs/2026-02-26/p0-governed-execution/verification/T05_signature_report.md"
      type: "新建|修改"
      schema_ref: "n/a"
  constraints:
    - "不得越权修改其他任务输出文件"
...
compliance:
  required: true
  attestation_path: "docs/2026-02-26/p0-governed-execution/verification/T05_compliance_attestation.json"
